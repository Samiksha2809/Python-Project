...
def createWidgets():
    ...
    label1 =Label(root, text="Player1", font=('times 20 bold'), bg="white", fg="black", height=1, width=8)
    label1.grid(row=1, column=0)

    player1_name = Entry(root,textvariable=p1, bd=5)
    player1_name.grid(row=1,column=1, columnspan=4)

    label2 =Label(root, text="Player2", font=('times 20 bold'), bg="white", fg="black", height=1, width=8)
    ...
    global button1
    button1 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button1) )
    button1.grid(row=3, column=0)

    global button2
    button2 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button2) )
    button2.grid(row=3, column=1)
    
    global button3
    button3 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button3) )
    button3.grid(row=3, column=2)

    global button4
    button4 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button4) )
    button4.grid(row=4, column=0)

    global button5
    button5 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button5) )
    button5.grid(row=4, column=1)

    global button6
    button6 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button6) )
    button6.grid(row=4, column=2)

    global button7
    button7 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button7) )
    button7.grid(row=5, column=0)
    
    global button8
    button8 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button8) )
    button8.grid(row=5, column=1)

    global button9
    button9 = Button(root, text="", font=('times 20 bold'), bg="gray", fg="white", height=4, width=8, command=lambda:Btnclick(button9) )
...
def checkforwin():
    ...
    if (button1["text"]=="X" and button2["text"]=="X" and button3["text"]=="X") or (button4["text"]=="X" and button5["text"]=="X" and button6["text"]=="X") or (button7["text"]=="X" and button8["text"]=="X" and button9["text"]=="X") or (button1["text"]=="X" and button5["text"]=="X" and button9["text"]=="X") or (button3["text"]=="X" and button5["text"]=="X" and button7["text"]=="X") or (button1["text"]=="X" and button4["text"]=="X" and button7["text"]=="X") or (button2["text"]=="X" and button5["text"]=="X" and button8["text"]=="X") or (button3["text"]=="X" and button6["text"]=="X" and button9["text"]=="X"):
        ...
        disablebuttons()
        messagebox.showinfo("Tic Tac Toe", pb)
